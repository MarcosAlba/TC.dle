...
`assets/js/circuitos.js` es la única fuente de verdad del modo Circuitos: alimenta la selección diaria, el buscador, las respuestas y el resultado final. En esta versión contiene **30 sedes de la era moderna (1997–2026)** y **33 configuraciones jugables**.
...
- Buenos Aires, circuito N.º 12 con y sin chicana.
